defmodule MeksDevWeb.BlogsLive.PullRequest do
  ...
  def render(assigns) do
    ...
    <div class={container_classes()}>
      ...
      <h3 class={h3_classes()}>Published 2025-09-23</h3>
      ...
      <p class={p_classes()}>
        There are a few factors that make narrowing down when and how a regression was introduced more challenging. If a commit doesn't compile, I can't isolate whether the bug first appeared there. If the bug appeared in a commit that had hundreds of lines of code changed, determining which part of the commit is the issue requires significantly more reasoning. A clean commit history with messages that tell a story make these kinds of investigations easier.
      </p>
      ...
      <ul class={ul_classes()}>
        <li class={li_classes()}>
          ...
          for showing what revision and author last modified each line of a file
        </li>
        <li class={li_classes()}>
  ...
  defp img_classes, do: "mx-auto my-6 w-full max-w-md rounded-lg shadow"
